...
class Main extends Component {
    ...
    componentDidMount = () => {
        ...
        if (this.props.characterinfo) {
            ...
            for (let num in gamelist) {
                let chan = "10P = " + exchangerate[num].exchange_rate + "0";
                list.push(<div key={num}><Chart name={gamelist[num].name_game} change={chan} img={gamelist[num].image_path} gameintro={gamelist[num].game_intro} isOpen={this.isOpen} alt="" /></div>);
            }
        }
        this.setState({
            gamelist: list
